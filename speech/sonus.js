...
const Sonus = {}
Sonus.annyang = require('./annyang-core')
...
Sonus.init = (options, recognizer) => {
  ...
  opts.hotwords.forEach(model => {
    models.add({
      file: model.file || path.join(__dirname, '../node_modules/snowboy/resources/snowboy.umdl'),
  ...
  // defaults
  opts.models = models
  opts.resource = opts.resource || path.join(__dirname, '../node_modules/snowboy/resources/common.res')
